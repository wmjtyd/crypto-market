...
const CLIENT_DEVICE_URL: &str = "ipc:///tmp/pubsub_example_front.ipc";
const SERVER_DEVICE_URL: &str = "ipc:///tmp/pubsub_example_back.ipc";
...
fn device(topic: &[u8]) {
    ...
    Socket::device(&front_socket, &back_socket).unwrap();
